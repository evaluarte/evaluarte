Public Class Llamar_Reporte_Material

    Private Sub Llamar_Reporte_Material_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        CARGAR()
    End Sub
