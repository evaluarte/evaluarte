Public Class Reporte_Grupo_Promedios_Niveles_Pensamiento
    ...
    Private Sub Notas_Colegio_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        CARGAR()
    End Sub
