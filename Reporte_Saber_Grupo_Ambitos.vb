Public Class Reporte_Saber_Grupo_Ambitos
    ...
    Private Sub Reporte_Saber_Grupo_Ambitos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        CARGAR()
    End Sub
