Public Class Reporte_Niveles_Estilos_Individuales
    ...
    Private Sub Reporte_Niveles_Estilos_Individuales_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        CARGAR()
    End Sub
