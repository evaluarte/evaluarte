Public Class Reporte_Saber_Grado_Promedios_Generales
    ...
    Private Sub Repote_Saber_Grado_Promedios_Generales_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        CARGAR()
    End Sub
