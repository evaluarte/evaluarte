Public Class Reporte_Saber_Grupo_Promedios_Generales
    ...
    Private Sub Reporte_Saber_Grupo_Promedios_Generales_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        CARGAR()
    End Sub
