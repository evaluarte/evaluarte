...
Public Class Reportar_Ingresos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "evaluarte.Reportar_Ingresos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportar_Ingresos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reportar_Ingresos = New Reportar_Ingresos()
        rpt.Site = Me.Site
        Return rpt
    End Function
