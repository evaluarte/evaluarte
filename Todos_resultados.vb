...
Public Class Todos_resultados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "evaluarte.Todos_resultados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTodos_resultados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Todos_resultados = New Todos_resultados()
        rpt.Site = Me.Site
        Return rpt
    End Function
