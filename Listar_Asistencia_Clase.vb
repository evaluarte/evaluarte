Public Class Listar_Asistencia_Clase

    Private Sub Listar_Asistencia_Clase_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        CARGAR()
    End Sub
