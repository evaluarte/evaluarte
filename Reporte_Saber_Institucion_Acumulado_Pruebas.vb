Public Class Reporte_Saber_Institucion_Acumulado_Pruebas
    ...
    Private Sub Reporte_Saber_Institucion_Acumulado_Pruebas_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        CARGAR()
    End Sub
    ...
    Private Sub BTNCALIFICAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNCALIFICAR.Click
        ...
        ElseIf CBOTIPO.Text = "saber 10 y 11" Then
            ...
            'BORRAR TODOS LOS DATOS DE LA TABLA Acumulado_Simulacros  es una tabla auxiliar los datos no se pierden porque estan en otras tablas que no se borran esto es solo para el reporte
            ...
            cant_registros = DQ.Tables(0).Rows.Count  'cantidad de registros  no repetidos 

            For n = 0 To cant_registros - 1

                codigoestudiante = DQ.Tables(0).Rows(n).Item(0).ToString
                Dim CMATERIA_FLEXIBLE As New OleDb.OleDbDataAdapter("SELECT proTotal FROM Resultados_Saber_Decimo_Once WHERE codigo='" & codigoestudiante & "' AND Codigo_Prueba='4' ORDER BY fecha", CN)
                Dim DATA_Simulacros_Promedio As New DataSet
