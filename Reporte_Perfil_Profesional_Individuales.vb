Public Class Reporte_Perfil_Profesional_Individuales
    ...
    Private Sub Reporte_Perfil_Profesional_Individuales_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        CARGAR()
    End Sub
