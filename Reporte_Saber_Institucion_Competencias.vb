Public Class Reporte_Saber_Institucion_Competencias
    ...
    Private Sub Reporte_Saber_Institucion_Competencias_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        CARGAR()
    End Sub
