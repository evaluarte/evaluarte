...
Public Class Reporte_Saber_Institucion_Asertividad
    ...
    Private Sub BTNCALIFICAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNCALIFICAR.Click
        ...
        ElseIf CBOTIPO.Text = "Mi Saber Aprueba" Then
            ...
            '%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% OBTENER NÚMERO DE PREGUNTAS DE CADA SESION %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            Dim DA As New OleDb.OleDbDataAdapter("SELECT codigo_estudiante FROM Auxiliar_Reporte_Asertividad_Preguntas_Saber_Sesion2 WHERE sesion='1' AND codigo_colegio='" & CBOCODIGOSEDE.Text & "'AND Identificacion_Prueba= '" & CBOSIMULACRO.Text & "'  ORDER BY codigo_estudiante ASC", CN)
            Dim DQ As New DataSet
            DA.Fill(DQ, "Auxiliar_Reporte_Asertividad_Preguntas_Saber_Sesion2")
            cant_registros = DQ.Tables(0).Rows.Count
        ...
        ElseIf CBOTIPO.Text = "saber 4,6,7 y 8" Then
            ...
            cantidad_preguntas_simulacro_creado = DATA_FORMATO1.Tables(0).Rows.Count
            '%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% OBTENER NÚMERO DE PREGUNTAS DE CADA SESION %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            Dim DA As New OleDb.OleDbDataAdapter("SELECT codigo_estudiante FROM Auxiliar_Reporte_Asertividad_Preguntas_Saber_Sesion2 WHERE codigo_colegio='" & CBOCODIGOSEDE.Text & "'AND Identificacion_Prueba= '" & CBOSIMULACRO.Text & "'  ORDER BY codigo_estudiante ASC", CN)
            Dim DQ As New DataSet
            DA.Fill(DQ, "Auxiliar_Reporte_Asertividad_Preguntas_Saber_Sesion2")
            cant_registros = DQ.Tables(0).Rows.Count
            ...
            Else
                ...
                For y = 0 To cant_registros - 1    'cant_registros: 
                    ...
                    codigoestudiante = DQ.Tables(0).Rows(y).Item(0).ToString
                    Dim DB1 As New OleDb.OleDbDataAdapter("SELECT  * FROM Auxiliar_Reporte_Asertividad_Preguntas_Saber_Sesion2 WHERE codigo_estudiante='" & codigoestudiante & "' AND codigo_colegio='" & CBOCODIGOSEDE.Text & "'AND Identificacion_Prueba= '" & CBOSIMULACRO.Text & "'", CN)
