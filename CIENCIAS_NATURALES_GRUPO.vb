Public Class CIENCIAS_NATURALES_GRUPO
    ...
    Private Sub CIENCIAS_NATURALES_GRUPO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        CARGAR()
    End Sub
