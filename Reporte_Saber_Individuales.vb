Public Class Reporte_Saber_Individuales_Lectura
    ...
    Private Sub Reporte_Saber_Individuales_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        CARGAR()
    End Sub
